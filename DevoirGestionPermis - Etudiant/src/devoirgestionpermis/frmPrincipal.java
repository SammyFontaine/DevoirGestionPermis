...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        // Le contrôle graphique lstTests
        // prend comme modèle le dlmTests
    ...
    private void btnInscriptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInscriptionActionPerformed
        ...
        else
        {
            ...
            {
                //je test si il y a deja des inscrits
                
                //au debut aucun eleve n'est inscrit
                ...
                if(gst.getLesElevesInscrits().isEmpty())
                {
                        ...
                        cboElevesInscrits.addItem(e.getNomEleve());
                ...
                {
                    // je vérifie que l'eleve n'est pas déjà inscrit pour ce test
                    // je parcourt la liste des inscrits
                    
                    
                    int i = 0;
                    for(Eleve e : gst.getLesElevesInscrits())
                    {
                        // Si on a trouvé l'eleve : ça veut dire qu'il est déjà inscrit 
                        if(e.getNomEleve().compareTo(gst.GetUnEleve(lstEleves.getSelectedIndex()).toString())==0)
                        {
                            trouveEleve = true;
                            eleve = e;
                            for(Test t : gst.getLesElevesInscrits().get(i).getSesTests())
                            {
                                if(t.getNomTest().compareTo(gst.GetUnTest(lstTests.getSelectedIndex()).toString())==0)
                        //      if(t.getNomTest().compareTo(lstTests.getValueAt(lstTests.getSelectedIndex(), 0).toString())==0)
                ...
                //on test si on a trouvé le test 
                if(trouveTest)
                {
                    //deja inscrit
                ...
                else
                {
                    if(!trouveEleve)
                    {
                        //on peut inscrire cet eleve a un test
                        Eleve e = gst.GetUnEleve(lstEleves.getSelectedIndex());
                        cboElevesInscrits.addItem(e.getNomEleve());
                        
                        Test t = new Test(
                        gst.getTousLesTests().get(lstTests.getSelectedIndex()).getIdTest(),
                        gst.getTousLesTests().get(lstTests.getSelectedIndex()).getNomTest(),
                        gst.getTousLesTests().get(lstTests.getSelectedIndex()).getNbFautes(),
                        gst.getTousLesTests().get(lstTests.getSelectedIndex()).getTermine()
                        );
